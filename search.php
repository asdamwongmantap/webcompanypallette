...
<body>
  ...
  <ul class="row clearfix rr list-display product">
		...
		$produk=mysql_query("SELECT * FROM produk WHERE nama_produk like '%$cari%' ORDER BY id_produk ASC LIMIT $posisi, $batas");
		$no = $posisi+1;
        ...
        echo"<li class='span9'>
            ...
            <div class="products-view-nav row bottom">
              ...
              <div class="span6">
                ...
                <?php
				  $jmldata     = mysql_num_rows(mysql_query("SELECT * FROM produk WHERE nama_produk like '%$cari'"));
