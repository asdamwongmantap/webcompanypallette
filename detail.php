            ...
            <div class="row">              
              <div class="span5 gallery">
                <div class="gallery-sub-wrap clearfix">
                  ...
                  <ul class='rr images'>
                  <?php
					$detail=mysql_query("select * from produk where id_produk='$_GET[id]'");
					//menampilkan gambar yg pertama pada produk detail
				 	$detail1=mysql_query("select * from produk where id_produk='$_GET[id]'");
           ...
           echo"<div class='span5 product'>";
            ...
            <div class="prod-info clearfix">
              ...
              <ul class="rr content">
                ...
                <tr><td>&nbsp;</td><td><input type="submit" name="submit" value="KIRIM" style="height:30px;width:70px;margin-top:10px;"></td></tr>
                </form></table>
                  </p>
                </li>
              </ul>
