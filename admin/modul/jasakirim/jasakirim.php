                ...
                <div class='span12'>                    
                    ...
                    <div class='block-fluid table-sorting clearfix'>
                        <table cellpadding='0' cellspacing='0' width='100%' class='table' id='tSortable'>
							...
							$jasakirim=mysql_query('SELECT * FROM jasa_pengiriman ORDER BY id_perusahaan ASC');
...
break;
case "edit":
	$edit = mysql_query("SELECT * FROM jasa_pengiriman WHERE id_perusahaan='$_GET[id]'");
