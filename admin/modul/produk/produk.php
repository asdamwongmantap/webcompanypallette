            ...
            <div class='row-fluid'>
                <div class='span6'>
                  <div class='block-fluid'>                        
					...
					<div class='row-form clearfix'>
                            <div class='span3'>Warna</div>
                            <div class='span9'><input type='text' name='warna' value='$r[warna]'/></div>
                    </div>
					 ...
					 <div class='row-form clearfix'>
							...
							<br>
							* Apabila gambar tidak diubah, dikosongkan saja.</br>
							* Gambar Harus Bertipe .jpeg/.jpg
							</div>
                    </div>
            ...
            <div class='row-fluid'>
                <div class='span6'>
                  <div class='block-fluid'>                        
					...
					<div class='row-form clearfix'>
                            <div class='span3'>Warna</div>
                            <div class='span9'><input type='text' name='warna'/></div>
                    </div>
