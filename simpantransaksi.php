                ...
                <div class="row">
                  <div class="span9 content-wrapper clearfix">
						...
						for ($i = 0; $i < $jml; $i++){
						  ...
						  mysql_query("UPDATE produk SET stok = stok -  {$isikeranjang[$i]['jumlah']}, dibeli=dibeli + 1 WHERE id_produk = {$isikeranjang[$i]['id_produk']} ");
						...
						echo "<table cellpadding=10 border=0>
							  <tr bgcolor=#ccc><th>No</th><th>Nama Produk</th><th>Berat(Kg)</th><th>Qty</th><th>Harga Satuan</th><th>Sub Total</th></tr>";
						...
						echo "<p>Data order dan nomor rekening transfer sudah terkirim ke email Anda. <br />
